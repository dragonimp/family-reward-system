        ...
        <head>
          ...
          <style>
            *{box-sizing:border-box}
            ...
            .watch-shell{position:relative;width:calc(100vw - 52px);height:calc(100vw - 52px);width:calc(100vmin - 8px);height:calc(100vmin - 8px);max-width:300px;max-height:300px;margin:0}
            @supports (aspect-ratio:1 / 1){.watch-shell{aspect-ratio:1 / 1}}
            @supports (width:min(100px,100%)){.watch-shell{--watch-size:min(calc(100vw - 8px),calc(100vh - 8px),346px);width:var(--watch-size);height:var(--watch-size);max-width:100%;max-height:100%;margin:0}}
            @supports(height:100dvh){@supports (width:min(100px,100%)){.watch-shell{--watch-size:min(calc(100vw - 8px),calc(100dvh - 8px),346px)}}}
            .watch-face{position:relative;width:100%;height:100%;overflow:hidden;border-radius:0;border:8px solid #17231b;border:clamp(6px,2.8vmin,10px) solid #17231b;background:#f9fbf7;box-shadow:0 12px 30px rgba(16,32,25,.2),inset 0 0 0 1px #cad7ce}
            .watch-face:before{content:"";position:absolute;top:12px;right:12px;bottom:12px;left:12px;inset:clamp(8px,4vmin,14px);border:1px solid #d8e2dc;border-radius:0;pointer-events:none}
            ...
            .watch-face.face-meteor:after,.watch-face.face-snow:after,.watch-face.face-flowers:after,.watch-face.face-night:after,.watch-face.face-pixel:after{content:"";position:absolute;inset:0;z-index:0;pointer-events:none}.watch-face > *{position:relative;z-index:1}
            .watch-face.face-meteor:after{background:linear-gradient(128deg,transparent 0 36%,rgba(255,255,255,.95) 40%,rgba(255,220,163,.72) 43%,transparent 50%);transform:translate3d(-52%,-42%,0) rotate(-8deg);animation:vip-meteor 5.6s ease-in-out infinite}.watch-face.face-snow:after{background-image:radial-gradient(circle,rgba(255,255,255,.86) 0 1.2px,transparent 1.8px),radial-gradient(circle,rgba(255,255,255,.56) 0 1.8px,transparent 2.3px);background-size:25px 25px,38px 38px;background-position:0 0,13px -16px;animation:vip-snow 7s linear infinite}.watch-face.face-flowers:after{background:radial-gradient(circle at 20% 38%,rgba(255,255,255,.86) 0 3%,transparent 3.8%),radial-gradient(circle at 73% 22%,rgba(255,255,255,.78) 0 2.5%,transparent 3.3%),radial-gradient(circle at 67% 78%,rgba(255,247,173,.88) 0 3%,transparent 3.8%);animation:vip-blossom 4.8s ease-in-out infinite}.watch-face.face-night:after{background:radial-gradient(circle at 68% 25%,rgba(255,255,255,.94) 0 1%,transparent 1.8%),radial-gradient(circle at 38% 56%,rgba(184,218,255,.78) 0 1.1%,transparent 2%),radial-gradient(circle at 82% 70%,rgba(255,255,255,.74) 0 .9%,transparent 1.7%);animation:vip-twinkle 3.6s ease-in-out infinite}.watch-face.face-pixel:after{background:linear-gradient(90deg,transparent 0 18%,rgba(255,255,255,.26) 18% 22%,transparent 22% 48%,rgba(255,255,255,.22) 48% 52%,transparent 52% 80%,rgba(255,255,255,.2) 80% 84%,transparent 84%);background-size:42px 100%;animation:vip-pixel 4.8s steps(4,end) infinite}
            @keyframes vip-meteor{0%,58%{transform:translate3d(-52%,-42%,0) rotate(-8deg);opacity:0}64%{opacity:1}82%,100%{transform:translate3d(52%,42%,0) rotate(-8deg);opacity:0}}@keyframes vip-snow{to{background-position:25px 72px,38px 52px}}@keyframes vip-blossom{0%,100%{transform:scale(.9) rotate(-3deg);opacity:.55}50%{transform:scale(1.08) rotate(3deg);opacity:1}}@keyframes vip-twinkle{0%,100%{opacity:.35;transform:scale(.9)}50%{opacity:1;transform:scale(1.08)}}@keyframes vip-pixel{0%,100%{background-position:0 0}50%{background-position:42px 0}}
            ...
            .menu-dock{position:absolute;right:8px;right:clamp(6px,2.5vmin,10px);top:8px;top:clamp(6px,2.5vmin,10px);z-index:3;transform:none}
            ...
            #app-panel .panel:not([data-panel=home]){height:100%;padding:1px 5px 4px 1px;overflow-x:hidden;overflow-y:auto;overscroll-behavior:contain;scrollbar-color:#5d7768 transparent;scrollbar-gutter:stable;scrollbar-width:thin;touch-action:pan-y}#app-panel .panel:not([data-panel=home])::-webkit-scrollbar{width:4px}#app-panel .panel:not([data-panel=home])::-webkit-scrollbar-thumb{border-radius:4px;background:#5d7768}#app-panel .panel:not([data-panel=home])::-webkit-scrollbar-track{background:transparent}
            ...
            @media(max-width:260px),(max-height:260px){.watch-shell{width:calc(100vmin - 8px);height:calc(100vmin - 8px)}.screen{inset:12px}.panel h1,.panel h2{font-size:16px}.rules{gap:4px}input,textarea{font-size:13px;padding:6px}}
